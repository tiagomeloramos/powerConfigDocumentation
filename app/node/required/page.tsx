          ...
          <TabsContent value="overview" className="space-y-6 pt-4">
            <div className="space-y-4">
              ...
              <div className="bg-gray-800/50 rounded-lg border border-gray-700 mt-6">
                <Image
                  src="/powerConfigDocumentation/images/required/required-fields-overview.png" // Replace with your actual image path
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-900 p-4 rounded-lg border border-gray-700">
                    <Image
                      src="/powerConfigDocumentation/images/required/required-fields-list.png" // Replace with your actual image path
                ...
                <div className="space-y-4 pt-4">
                  ...
                  <div className="bg-gray-900 p-4 rounded-lg border border-gray-700 mt-4">
                    <Image
                      src="/powerConfigDocumentation/images/required/add-validation-rule.png" // Replace with your actual image path
